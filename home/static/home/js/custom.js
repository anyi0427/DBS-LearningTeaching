...
/*Dropdown Menu*/
$('.dropdown00').click(function () {
    $(this).attr('tabindex', 1).focus();
    $(this).toggleClass('active');
    $(this).find('.dropdown-menu').slideToggle(300);
});
$('.dropdown00').focusout(function () {
    $(this).removeClass('active');
    $(this).find('.dropdown-menu').slideUp(300);
});
$('.dropdown00 .dropdown-menu li').click(function () {
    $(this).parents('.dropdown00').find('span').text($(this).text());
    $(this).parents('.dropdown00').find('input').attr('value', $(this).attr('id'));
});
/*End Dropdown Menu*/


$('.dropdown-menu li').click(function () {
var input = '<strong>' + $(this).parents('.dropdown00').find('input').val() + '</strong>',
