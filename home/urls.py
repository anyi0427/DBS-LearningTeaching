...
urlpatterns = [
   ...
   path('tracuu_lophoc_giangvien7', views.tracuu_lophoc_giangvien7, name = "tracuu_lophoc_giangvien7"),
   path('tracuu_hocky_sinhvien6', views.tracuu_hocky_sinhvien6, name = "tracuu_hocky_sinhvien6"),
]
